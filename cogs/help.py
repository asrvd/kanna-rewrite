...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        view=HelpView(ctx)
        btn1 = Button(label="Contact Developer", style=discord.ButtonStyle.url, url="https://discordapp.com/users/926870214254153739")
        btn3 = Button(label="Support Server", style=discord.ButtonStyle.url, url="https://discord.gg/7CYP8pKzDB")
        btn2 = Button(label="Invite", style=discord.ButtonStyle.url, url="https://discordapp.com/api/oauth2/authorize?client_id=922887317218279444&permissions=8&scope=bot%20applications.commands")
        view.add_item(btn1)
        view.add_item(btn3)
        view.add_item(btn2)
