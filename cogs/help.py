...
options = [
    discord.SelectOption(
        ...
        emoji=discord.PartialEmoji(name="mod", id=928226643607183421),
    ),
    discord.SelectOption(
        label="Utility",
        description="List of Utility Commands",
        emoji=discord.PartialEmoji(name="util", id=928226643250663454),
    ),
    discord.SelectOption(
        label="Games",
        description="List of Games available.",
        emoji=discord.PartialEmoji(name="game", id=928226643439419412),
    ),
    discord.SelectOption(
        label="Fun",
        description="List of Fun Commands.",
        emoji=discord.PartialEmoji(name="fun", id=928226643363901441),
    ),
    discord.SelectOption(
        label="Memes",
        description="List of Meme Commands.",
        emoji=discord.PartialEmoji(name="meme", id=928226643821080576),
    ),
]
...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        emb.set_author(name="⊱┊Help Menu for Kanna", icon_url=ctx.author.display_avatar)
        emb.set_footer(
        ...
        btn1 = Button(
            ...
            url="https://discordapp.com/users/926870214254153739",
        )
        btn3 = Button(
        ...
        btn2 = Button(
            label="Invite",
            style=discord.ButtonStyle.url,
            url="https://discordapp.com/api/oauth2/authorize?client_id=922887317218279444&permissions=8&scope=bot%20applications.commands",
        )
        view.add_item(btn1)
        view.add_item(btn3)
        view.add_item(btn2)
